...
namespace HASSAgent.Controls.Service
{
    ...
    public partial class MQTT : UserControl
    {
            ...
            try
            {
                ...
                while (_statusUpdateActive)
                {
                    ...
                    Invoke(new MethodInvoker(delegate
                    {
                        ...
                        LblStatus.Text = "error fetching status, check logs";
                    }));
                }
            }
            catch 
        ...
        private async void BtnStore_Click(object sender, EventArgs e)
        {
            ...
            if (!storedOk) MessageBoxAdv.Show("An error occured while saving the configuration, check the logs for more info.", "HASS.Agent", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void UnlockUi()
        {
            ...
            BtnStore.Text = "send and activate config";
