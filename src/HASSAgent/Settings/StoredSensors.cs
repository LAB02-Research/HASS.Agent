...
using HASSAgent.Shared.Models.HomeAssistant.Sensors.GeneralSensors.MultiValue;
using HASSAgent.Shared.Models.HomeAssistant.Sensors.GeneralSensors.SingleValue;
using HASSAgent.Shared.Models.HomeAssistant.Sensors.PerfCounterSensors.SingleValue;
using HASSAgent.Shared.Models.HomeAssistant.Sensors.WmiSensors.SingleValue;
