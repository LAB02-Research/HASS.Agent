...
namespace HASS.Agent.Controls.Service
{
    public partial class Sensors : UserControl
    {
        ...
        private async void BtnStore_Click(object sender, EventArgs e)
        {
            ...
            if (!storedOk) MessageBoxAdv.Show("An error occured while saving the sensors, check the logs for more info.", "HASS.Agent", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void UnlockUi()
        {
            ...
            BtnStore.Text = "send and activate sensors";
            _storing = false;
