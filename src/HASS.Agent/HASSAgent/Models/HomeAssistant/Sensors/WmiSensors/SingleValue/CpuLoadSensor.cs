...
namespace HASSAgent.Models.HomeAssistant.Sensors.WmiSensors.SingleValue
{
    ...
    {
        public CpuLoadSensor(int? updateInterval = null, string name = "CpuLoadSensor", string id = default) : base("SELECT PercentProcessorTime FROM Win32_PerfFormattedData_PerfOS_Processor", updateInterval ?? 30, name ?? "CpuLoadSensor", id) {}
