...
namespace HASSAgent.Forms
{
    public partial class Configuration : MetroForm
    {
        ...
        private void BtnStore_Click(object sender, System.EventArgs e)
        {
            ...
            // notify user about the rest
            MessageBoxAdv.Show("Configuration have been saved. Some changes may require an application restart before they take effect.", "HASS.Agent", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private async void BtnCreateLaunchOnBootTask_Click(object sender, System.EventArgs e)
        {
            ...
            using (var userCredentials = new GetUserCredentials())
            {
                ...
                if (created)
                {
                    ...
                    MessageBoxAdv.Show("The task has sucessfully been created, and will execute the next time you login.", "HASS.Agent", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
            }
